...
# documentation.
html_theme_options = {
  'source_repository': 'https://github.com/driplineorg/controls-guide',
  'source_branch': 'main',
...
htmlhelp_basename = 'DriplineControlsGuidedoc'
...
latex_documents = [
    (master_doc, 'DriplineControlsGuide.tex', u'Dripline Controls Guide Documentation',
     u'Driplineorg Maintainers', 'manual'),
]
...
man_pages = [
    (master_doc, 'driplinecontrolsguide', u'Dripline Controls Guide Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'DriplineControlsGuide', u'Dripline Controls Guide Documentation',
     author, 'DriplineControlsGuide', 'One line description of project.',
     'Miscellaneous'),
]
